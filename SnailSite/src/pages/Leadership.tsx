...
const Leadership: React.FC = () => {
    ...
    return (
        <div className="text-center pr-10 pl-10 pt-3 pb-10">
            <h1 className="text-3xl font-bold mb-4">Student Leadership</h1>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {leadershipData.map((leader) => (
                    ...
                    >
                        ...
                        <br />
                        <span className="text-xs">{leader.school}, Grade {leader.grade}</span>
                    </div>
                ))}
            </div>

            <h1 className="text-3xl font-bold mt-8 mb-4">Advisors</h1>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    <div
                        key="Mrs. Cook"
                        className={`p-4 border border-gray-300 rounded transition-transform transform ${
